/*
   this is a bitmapped font.
   specs:
   size: 8x8
   start: 32
   chars: 96
   range: 32-127(may not seem right, just remember is starts at 0)

   each char corresponds to a line of pixels, each pixel is one bit,
   the MSB is the leftmost pixel, and the LSB is the rightmost.
*/

unsigned char font_8x8_32_96[96*8]={
...
0x00, 0x30, 0x30, 0x18, 0x00, 0x00, 0x00, 0x00, /* 0x60 "`"*/
...
0x00, 0x0E, 0x18, 0x70, 0x18, 0x18, 0x0E, 0x00, /* 0x7B "{" */
0x00, 0x18, 0x18, 0x00, 0x18, 0x18, 0x18, 0x00, /* 0x7C "|" */
0x00, 0x70, 0x18, 0x0E, 0x18, 0x18, 0x70, 0x00, /* 0x7D "}" */
0x00, 0x77, 0xDC, 0x00, 0x00, 0x00, 0x00, 0x00, /* 0x7E "~" */
0x00, 0x00, 0x00, 0x08, 0x1C, 0x36, 0x63, 0x7F, /* 0x7F "\x7F" */
};
