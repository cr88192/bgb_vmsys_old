...
db "MSDOS5.0"
;fat shit
sbytes	dw 512	;bytes/sector
csize	db 1	;sectors/cluster
rsize	dw 1	;reserved
fats	db 2	;fats
rents	dw 224	;root entries
sects	dw 2880	;total sectors
media	db 240	;dos media descriptor
fatsz	dw 9	;sectors/fat
tracksz	dw 18	;sectors/track
heads	dw 2	;heads
hidden	dd 0	;hidden
sects2	dd 0	;total sectors, sects=0
drive	db 0	;drive number
resv	db 0	;reserved
sig	db 0x29	;signature
serial	dd 0	;volume serial number
label	db "OS1FATBOOT1" ;volume label
fstype	db "FAT12   "
